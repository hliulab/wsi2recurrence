...
def argparser():
    # /ngs/wsi/PKG - CPTAC-CCRCC/CCRCC
    parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')
    parser.add_argument('--data', default=r"../tiles_40x", type=str, metavar='DIR',
                        help='path to dataset')
    parser.add_argument('--save_path', default="../model_save", type=str, help="model and record save path")
    ...
    parser.add_argument('--dataset', type=str, default="tcga_brca", help="Specify dataset: ImageNet or cifar10")
